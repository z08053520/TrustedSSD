...
#define THREAD_BUF_ADDR		(TEMP_BUF_ADDR + TEMP_BUF_BYTES)
#define THREAD_BUF_BYTES	(NUM_THREAD_BUFFERS * BYTES_PER_PAGE)

#define NON_SATA_BUF_END	(THREAD_BUF_ADDR + THREAD_BUF_BYTES)
